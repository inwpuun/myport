...
const buttonStyles = tv(
  {
    ...
    variants: {
      intent: {
        primary: [
          "text-primary-fg [--btn-bg:theme(colors.primary.DEFAULT)] [--btn-border:theme(colors.primary.DEFAULT)]",
          "[--btn-icon:theme(colors.primary.fg/60%)] active:[--btn-icon:theme(colors.primary.fg/80%)]",
        ],
        secondary: [
